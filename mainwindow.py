...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.Sort_ID_pushButton.clicked.connect(self.OrdenId)
        self.ui.Sort_Distancia_pushButton_2.clicked.connect(self.OrdenDistancia)
        self.ui.Sort_Velocidad_pushButton_3.clicked.connect(self.OrdenVelocidad)
    ...
    @Slot()
    def OrdenId(self):
        self.administrador.SortCodigo()
    
    @Slot()
    def OrdenDistancia(self):
        self.administrador.SortDistancia()
    
    @Slot()
    def OrdenVelocidad(self):
        self.administrador.SortVelocidad()
